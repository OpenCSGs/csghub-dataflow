...
from data_server.datasource.services.connectors.file import FileConnector
...
def get_datasource_connector(datasource: DataSourceBase):
    ...
    elif datasource.source_type == DataSourceTypeEnum.FILE.value:  # FILE
        return FileConnector(datasource)
