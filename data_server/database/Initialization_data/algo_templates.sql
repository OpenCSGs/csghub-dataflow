...
-- ----------------------------
INSERT INTO "public"."algo_templates" VALUES (1, 'e8e543a8-b58c-4626-8b07-28b467527dae', '数据处理-高阶', '该配置文件用于定义数据处理流程，包含多个处理机制，如清理电子邮件、链接、字符规范化、文本过滤和去重等操作。用户可根据需求调整参数，以提高数据质量和处理效率，确保最终数据集的准确性和一致性。', 'data_refine', 't', 'dataflow-demo-process', '/path/to/your/dataset', '/path/to/your/dataset.jsonl', '3', 'f', '3', 'name: 数据处理-高阶
...
process:
  ...
  whitespace_normalization_mapper:
    ...
    position:
      x: 966.3579840012538
      ''y'': 263.60493318534185
    configs: []
  alphanumeric_filter:
    id: node_1755490879112_851
    operator_id: ''15''
  ...
  document_simhash_deduplicator:
    ...
    configs:
      ...
      - id: 103
        ...
        display_name: 汉明距离
edges:
  - source: node_1755490812574_987
    target: node_1755490820806_764
  - source: node_1755490820806_764
    target: node_1755490840952_976
  - source: node_1755490840952_976
    target: node_1755490850061_360
  - source: node_1755490850061_360
    target: node_1755490863671_77
  - source: node_1755490863671_77
    target: node_1755490879112_851
  - source: node_1755490879112_851
    target: node_1755490894171_140
  - source: node_1755490894171_140
    target: node_1755490914012_595
  - source: node_1755490914012_595
    target: node_1755490928918_249
  - source: node_1755490928918_249
    target: node_1755490939773_227
  - source: node_1755490954516_990
    target: node_1755490977581_157
  - source: node_1755490977581_157
    target: node_1755490984628_638
  - source: node_1755490984628_638
    target: node_1755490993106_661
  - source: node_1755491020815_741
    target: node_1755491044180_112
  - source: node_1755490993106_661
    target: node_1755491089966_48
  - source: node_1755491089966_48
    target: node_1755491020815_741
  - source: node_1755490939773_227
    target: node_1755490954516_990
', '2025-08-12 11:17:09.866443', '2025-08-12 17:30:01.807169');
INSERT INTO "public"."algo_templates" VALUES (2, 'e8e543a8-b58c-4626-8b07-28b467527dae', '数据增强', '该模版用于数据增强，旨在扩展用户的提示数据，以帮助模型更好地理解任务。', 'data_enhancement', 't', 'dataflow-demo-process', '/path/to/your/dataset', '/path/to/your/dataset.jsonl', '3', 'f', '3', 'name: 数据增强
...
INSERT INTO "public"."algo_templates" VALUES (3, 'e8e543a8-b58c-4626-8b07-28b467527dae', '数据生成', '该模版用于数据增强，旨在扩展用户的提示数据，以帮助模型更好地理解任务。', 'data_refine', 't', 'dataflow-demo-process', '/path/to/your/dataset', '/path/to/your/dataset.jsonl', '3', 'f', '3', 'name: 数据生成
description: 该模版用于数据增强，旨在扩展用户的提示数据，以帮助模型更好地理解任务。
type: data_refine
buildin: true
project_name: dataflow-demo-process
...
INSERT INTO "public"."algo_templates" VALUES (4, 'e8e543a8-b58c-4626-8b07-28b467527dae', '数据处理-基础', '该配置文件用于定义数据流处理的各个步骤，包括字符过滤、重复数据去除和中文转换等操作。', 'data_refine', 't', 'dataflow-demo-process', '/path/to/your/dataset', '/path/to/your/dataset.jsonl', '3', 'f', '3', 'name: 数据处理-基础
...
process:
  chinese_convert_mapper:
    ...
    position:
      x: -107.35010424257689
      ''y'': 270.21565340049403
    configs:
      - id: 121
        operator_id: 14
        config_name: mode
  ...
  clean_email_mapper:
    ...
    position:
      x: 146.6498957574231
      ''y'': 271.21565340049403
    configs: []
  alphanumeric_filter:
    id: node_1755499453328_150
    operator_id: ''15''
    operator_type: Filter
    operator_name: alphanumeric_filter
    display_name: 字母/数字占比过滤
  ...
  document_deduplicator:
    ...
    configs:
      ...
      - id: 15
        ...
        display_name: 忽略非字符
edges:
  - source: node_1755499429715_479
    target: node_1755499443576_486
  - source: node_1755499443576_486
    target: node_1755499453328_150
  - source: node_1755499453328_150
    target: node_1755499462851_243
  - source: node_1755499462851_243
    target: node_1755499480780_619
  - source: node_1755499480780_619
    target: node_1755499708533_141
  - source: node_1755499708533_141
    target: node_1755499750109_909
