...
-- ----------------------------
INSERT INTO "public"."algo_templates" VALUES (6, '0', '数据筛选', '该模版通过计算文本与目标查询的语义相似度，为每条数据生成质量评分，并根据分数阈值筛选高相关性内容。', 'data_refine', 't', 'dataflow-demo-process', '/path/to/your/dataset', '/path/to/your/dataset.jsonl', '3', 'f', '3', 'name: 数据筛选
...
INSERT INTO "public"."algo_templates" VALUES (8, '0', '数据去重', '该模版通过移除重复或高度相似的文本内容，包括句子级重复和文档级重复，减少数据冗余，从而提升数据集多样性。', 'data_refine', 't', 'dataflow-demo-process', '/path/to/your/dataset', '/path/to/your/dataset.jsonl', '3', 'f', '3', 'name: 数据去重
...
INSERT INTO "public"."algo_templates" VALUES (5, '0', '数据过滤', '该模版用于对结构化文本进行多维度质量过滤，通过文本长度、词汇比例、特殊字符等规则筛除不符合标准的样本，确保数据的基本质量。', 'data_refine', 't', 'dataflow-demo-process', '/path/to/your/dataset', '/path/to/your/dataset.jsonl', '3', 'f', '3', 'name: 数据过滤
...
INSERT INTO "public"."algo_templates" VALUES (4, '0', '数据生成', '该模版用于数据增强，旨在扩展用户的提示数据，以帮助模型更好地理解任务。', 'data_generation', 't', 'dataflow-demo-process', '/path/to/your/dataset', '/path/to/your/dataset.jsonl', '3', 'f', '3', 'name: 数据生成_复制
...
INSERT INTO "public"."algo_templates" VALUES (7, '0', '数据脱敏', '该模版清理文本中的敏感信息，包括邮箱地址、IP地址等隐私数据，确保数据可安全使用。', 'data_refine', 't', 'dataflow-demo-process', '/path/to/your/dataset', '/path/to/your/dataset.jsonl', '3', 'f', '3', 'name: 数据脱敏
...
process:
  node_1767605363798_587:
    ...
    position:
      ...
      ''y'': 249
    configs: []
  node_1773901085925_263:
    id: node_1773901085925_263
    operator_id: ''4''
    operator_type: Mapper
    ...
    configs:
      - id: 169
        operator_id: 4
        config_name: matching_rules
        config_type: textarea-array-data
        default_value: "版权所有[^。\\\\n]*[。]?\\\\s*\r\n保留所有权利[^。\\\\n]*[。]?\\\\s*\r\n未经授权[^。\\\\n]*[。]?\\\\s*\r\n未经许可[^。\\\\n]*[。]?\\\\s*\r\n禁止转载[^。\\\\n]*[。]?\\\\s*\r\n严禁转载[^。\\\\n]*[。]?\\\\s*\r\n不得转载[^。\\\\n]*[。]?\\\\s*\r\n禁止复制[^。\\\\n]*[。]?\\\\s*\r\n禁止传播[^。\\\\n]*[。]?\\\\s*\r\n侵权必究[^。\\\\n]*[。]?\\\\s*\r\n著作权[^。\\\\n]*[。]?\\\\s*"
        is_required: false
        is_spinner: false
        final_value: null
...
edges:
  ...
  - source: node_1767605363798_587
    target: node_1773901085925_263
  - source: node_1773901085925_263
    target: node_1767605373408_797
', '2026-01-05 17:30:19.263498', '2026-03-19 14:18:12.156721');
INSERT INTO "public"."algo_templates" VALUES (2, '0', '数据处理-高阶', '该配置文件用于定义数据处理流程，包含多个处理机制，如清理电子邮件、链接、字符规范化、文本过滤和去重等操作。用户可根据需求调整参数，以提高数据质量和处理效率，确保最终数据集的准确性和一致性。', 'data_refine', 't', 'dataflow-demo-process', '/path/to/your/dataset', '/path/to/your/dataset.jsonl', '1', 'f', '3', 'name: 数据处理-高阶
...
INSERT INTO "public"."algo_templates" VALUES (3, '0', '数据增强', '该模版用于数据增强，旨在扩展用户的提示数据，以帮助模型更好地理解任务。', 'data_enhancement', 't', 'dataflow-demo-process', '/path/to/your/dataset', '/path/to/your/dataset.jsonl', '3', 'f', '3', 'name: 数据增强_复制
description: 该模版用于数据增强，旨在扩展用户的提示数据，以帮助模型更好地理解任务。
...
INSERT INTO "public"."algo_templates" VALUES (1, '0', '数据处理-基础', '该配置文件用于定义数据流处理的各个步骤，包括字符过滤、重复数据去除和中文转换等操作。', 'data_refine', 't', 'dataflow-demo-process', '/path/to/your/dataset', '/path/to/your/dataset.jsonl', '1', 'f', '3', 'name: 数据处理-基础
