...
INSERT INTO "public"."operator_info" VALUES (30, 'topk_specified_field_selector', 'Selector', 0, 't', 'M', NULL, NULL, 'api/v1/dataflow/real_static_files/operator/2ef54c00-67b1-4b39-bc2b-682e6a7a7b59.png', '2025-07-29 17:06:02.746543', '2025-07-30 14:43:04.545865', 't');
INSERT INTO "public"."operator_info" VALUES (61, 'pipeline_magpie_zh_mapper', 'Mapper', 0, 't', 'Using the deepseek-v2.5 or qwen2.5 model, generate multi-round dialogue data based on the manually designed system_prompt corresponding to multiple tasks', '', '', 'api/v1/dataflow/real_static_files/operator/413ddb18-167c-4e22-9177-f873530757ea.png', '2025-08-26 18:26:29.896376', '2025-08-27 11:40:27.323862', 't');
...
INSERT INTO "public"."operator_info" VALUES (56, 'make_cosmopedia_mapper', 'Mapper', 0, 't', 'Mapper to generate synthetic tutorial data from seed text samples.', 'How to Train Your Dog to Sit', 'Training your dog to sit is one of the most fundamental commands...', 'api/v1/dataflow/real_static_files/operator/376559b2-b641-4318-9f2f-b854b7ccc1e4.png', '2025-08-13 15:36:12.917019', '2025-08-25 17:03:24.746487', 't');
...
INSERT INTO "public"."operator_info" VALUES (58, 'encode_and_get_nearest_mapper', 'Mapper', 0, 't', 'Encode texts and find nearest neighbours using Faiss.', '数据集包含first_prompt字段的文本数据，如[''What is artificial intelligence?'', ''How does machine learning work?'']', '数据集增加了embedding、nn_indices和nn_scores字段，包含文本的向量表示和最近邻信息', 'api/v1/dataflow/real_static_files/operator/00ec2df9-63ce-4167-9b0f-b50a910157fd.png', '2025-08-18 10:05:33.199011', '2025-09-03 17:37:59.235146', 't');
