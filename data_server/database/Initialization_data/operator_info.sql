...
INSERT INTO "public"."operator_info" VALUES (58, 'encode_and_get_nearest_mapper', 'Mapper', 0, 't', 'Encode texts and find nearest neighbours using Faiss.', '数据集包含first_prompt字段的文本数据，如[''What is artificial intelligence?'', ''How does machine learning work?'']', '数据集增加了embedding、nn_indices和nn_scores字段，包含文本的向量表示和最近邻信息', 'api/v1/dataflow/real_static_files/operator/00ec2df9-63ce-4167-9b0f-b50a910157fd.png', '2025-08-18 10:05:33.199011', '2025-08-25 17:21:40.856365', 't');
