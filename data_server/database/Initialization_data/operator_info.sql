...
INSERT INTO "public"."operator_info" VALUES (1, 'flagged_words_filter', 'Filter', 0, 'f', 'Filter to keep samples with flagged-word ratio less than a specific max
    value.', '基于前一步结果，除掉骂人、脏字等污秽数据和敏感词', NULL, 'api/v1/dataflow/real_static_files/operator/7053eed0-b6a8-4a8a-9387-e1a0413fbce7.png', '2025-07-25 17:17:10.255559', '2025-07-30 14:34:12.397997');
INSERT INTO "public"."operator_info" VALUES (4, 'clean_copyright_mapper', 'Mapper', 0, 'f', 'Mapper to clean copyright comments at the beginning of the text
    samples.', '这是一段 /* 多行注释
注释内容copyright
*/ 的文本。另外还有一些 // 单行注释。', '这是一段  的文本。另外还有一些 // 单行注释。', 'api/v1/dataflow/real_static_files/operator/8430683a-eb75-4937-a20b-37ca5bce26b8.png', '2025-07-26 14:19:25.192786', '2025-07-30 14:36:31.80043');
...
', 'api/v1/dataflow/real_static_files/operator/b439841c-cbc8-4e71-9ee6-96325875f6e9.png', '2025-07-28 18:00:40.431969', '2025-07-30 14:37:54.224796');
...
', 'api/v1/dataflow/real_static_files/operator/b9bcd635-7325-4534-b57f-c15c9d1dd264.png', '2025-07-28 22:35:47.937164', '2025-07-30 14:43:13.484934');
INSERT INTO "public"."operator_info" VALUES (34, 'remove_repeat_sentences_mapper', 'Mapper', 0, 'f', 'Mapper to remove repeat sentences in text samples.', '今天天气真不错，阳光明媚，适合出去散步。小明说：“今天天气真不错，我们去海边吧。” 小红回答说：“好主意！” 但是，小李觉得：“今天天气真不错，我们去爬山吧。” 今天天气真不错，阳光明媚，适合出去散步。昨天下了一整天的雨，今天终于放晴了。昨天下了一整天的雨，今天终于放晴了。', '今天天气真不错，阳光明媚，适合出去散步。小明说：“今天天气真不错，我们去海边吧。” 小红回答说：“好主意！” 但是，小李觉得：“今天天气真不错，我们去爬山吧。”昨天下了一整天的雨，今天终于放晴了。', 'api/v1/dataflow/real_static_files/operator/1e86edad-423c-4334-ae62-ac2faea9d6cf.png', '2025-07-29 09:27:45.016877', '2025-07-30 14:43:36.759913');
INSERT INTO "public"."operator_info" VALUES (2, 'character_repetition_filter', 'Filter', 0, 'f', 'Filter to keep samples with char-level n-gram repetition ratio within a
    specific range.', 'Today is Sund Sund Sund Sund Sund Sunda and it''s a happy day!', NULL, 'api/v1/dataflow/real_static_files/operator/cc49d862-693b-4107-9353-3b40593b1fd8.png', '2025-07-25 17:12:04.389578', '2025-07-30 14:35:39.735916');
INSERT INTO "public"."operator_info" VALUES (3, 'clean_email_mapper', 'Mapper', 0, 'f', 'Mapper to clean email in text samples.', 'happy day euqdh@cjqi.com', 'happy day', 'api/v1/dataflow/real_static_files/operator/eb0a7ba0-f54e-4328-bc6b-dafb0ac7e3e6.png', '2025-07-25 17:01:23.81786', '2025-07-30 14:36:05.326827');
...
INSERT INTO "public"."operator_info" VALUES (7, 'fix_unicode_mapper', 'Mapper', 0, 'f', 'Mapper to fix unicode errors in text samples.', 'The Mona Lisa doesnÃƒÂ¢Ã¢â€šÂ¬Ã¢â€žÂ¢t have eyebrows.', 'The Mona Lisa doesn''t have eyebrows.', 'api/v1/dataflow/real_static_files/operator/9930ff2d-167b-426d-8294-901f5dbf0342.png', '2025-07-28 21:51:46.932663', '2025-07-30 14:38:09.802052');
...
hello_world()', 'message:[{"input": "create hello word function by python", "response": "def hello_world():
    print("Hello, World!")
hello_world()" }]', 'api/v1/dataflow/real_static_files/operator/9057f5d6-2116-4a85-a30b-9038f0208281.png', '2025-07-28 21:56:42.429', '2025-07-30 14:38:18.883288');
INSERT INTO "public"."operator_info" VALUES (9, 'clean_ip_mapper', 'Mapper', 0, 'f', 'Mapper to clean ipv4 and ipv6 address in text samples.', 'ftp://example.com/188.46.244.216my-page.html', 'ftp://example.com/my-page.html', 'api/v1/dataflow/real_static_files/operator/539ee039-5e9c-4268-a3e9-bca7a64ece8f.png', '2025-07-26 14:21:23.800177', '2025-07-30 14:37:33.257106');
...
INSERT INTO "public"."operator_info" VALUES (11, 'extract_qa_mapper', 'Mapper', 0, 'f', '
    ...
    ', '蒙古国的首都是乌兰巴托（Ulaanbaatar）', 'Human: 请问蒙古国的首都是哪里？Assistant: 你好，根据提供的信息，蒙古国的首都是乌兰巴托（Ulaanbaatar）', 'api/v1/dataflow/real_static_files/operator/2bc92637-2ca6-45d8-ab15-d54a6afe6706.png', '2025-07-28 18:10:15.17163', '2025-07-30 14:41:24.156999');
INSERT INTO "public"."operator_info" VALUES (12, 'document_deduplicator', 'Deduplicator', 0, 'f', '
    ...
    ', '{    ''text'':    ''This paper proposed a novel method on LLM pretraining.''},{    ''text'':    ''This paper proposed a novel method on LLM pretraining.''}', '{    ''text'':    ''This paper proposed a novel method on LLM pretraining.''},', 'api/v1/dataflow/real_static_files/operator/205a63c8-fa19-4542-add1-1b0744b95977.png', '2025-07-25 17:27:21.293129', '2025-07-30 14:39:24.563715');
INSERT INTO "public"."operator_info" VALUES (13, 'text_length_filter', 'Filter', 0, 'f', 'Filter to keep samples with total text length within a specific
    range.', 'Today is Sund Sund Sund Sund Sund Sunda and it''s a happy day!', NULL, 'api/v1/dataflow/real_static_files/operator/3ffa0e42-974a-4b14-ab08-9cb259f83512.png', '2025-07-25 17:23:47.854313', '2025-07-30 14:40:10.303067');
INSERT INTO "public"."operator_info" VALUES (14, 'chinese_convert_mapper', 'Mapper', 0, 'f', 'Mapper to convert Chinese between Traditional Chinese, Simplified Chinese and Japanese Kanji.', '这是几个简体字，会被转换为繁体字', '這是幾個簡體字，會被轉換爲繁體字', 'api/v1/dataflow/real_static_files/operator/26269c88-3453-4c8b-8333-ec6c9c939109.png', '2025-07-25 16:59:37.14472', '2025-07-30 14:40:18.970169');
...
', NULL, 'api/v1/dataflow/real_static_files/operator/7f317dc9-ba84-4660-b50f-f96b39049dba.png', '2025-07-25 17:07:16.848742', '2025-07-30 14:40:26.711944');
INSERT INTO "public"."operator_info" VALUES (16, 'nlpaug_en_mapper', 'Mapper', 0, 'f', 'Mapper to simply augment samples in English based on nlpaug library.', 'I am going to the park.', 'I am proceeding to the park.', 'api/v1/dataflow/real_static_files/operator/c47fc2a0-0c8e-4fd0-981e-9947903a608c.png', '2025-07-28 22:02:58.658819', '2025-07-30 14:40:34.720072');
INSERT INTO "public"."operator_info" VALUES (17, 'nlpcda_zh_mapper', 'Mapper', 0, 'f', 'Mapper to simply augment samples in Chinese based on nlpcda library.', '这里一共有5种不同的数据增强方法', '这里一共有伍种不同的数据增强方法', 'api/v1/dataflow/real_static_files/operator/983021a9-a149-4fb3-afe1-989f3d00fc9d.png', '2025-07-28 22:06:37.125394', '2025-07-30 14:40:43.117797');
INSERT INTO "public"."operator_info" VALUES (18, 'word_repetition_filter', 'Filter', 0, 'f', 'Filter to keep samples with word-level n-gram repetition ratio within a
    specific range.', '根据算子使用使用使用使用安装方案确定', NULL, 'api/v1/dataflow/real_static_files/operator/8c65e9aa-898e-4d25-aac2-9741623e7bb6.png', '2025-07-29 16:56:04.709136', '2025-07-30 14:40:57.296525');
INSERT INTO "public"."operator_info" VALUES (19, 'document_simhash_deduplicator', 'Deduplicator', 0, 'f', 'Deduplicator to deduplicate samples at document-level using SimHash.', NULL, NULL, 'api/v1/dataflow/real_static_files/operator/57593071-d5c2-4277-90af-99c524b7ea8c.png', '2025-07-29 17:05:32.159066', '2025-07-30 14:39:46.855227');
INSERT INTO "public"."operator_info" VALUES (20, 'text_action_filter', 'Filter', 0, 'f', 'Filter to keep texts those contain actions in the text..', '我有一只猫，它是一只猫', NULL, 'api/v1/dataflow/real_static_files/operator/0be7e20d-9f2f-4861-9b7e-485dd11dabed.png', '2025-07-29 16:49:06.936807', '2025-07-30 14:41:06.691885');
INSERT INTO "public"."operator_info" VALUES (22, 'punctuation_normalization_mapper', 'Mapper', 0, 'f', 'Mapper to normalize unicode punctuations to English punctuations in text samples.', '，。、„”“«»１」「《》´∶：？！（）；–—．～’…━〈〉【】％►', ',.,""""""""""''::?!();- - . ~''...-<>[]%-', 'api/v1/dataflow/real_static_files/operator/111cb13a-b085-49d8-9684-397c7ffa4b08.png', '2025-07-28 22:28:48.966792', '2025-07-30 14:41:56.607038');
...
%% This is file `sample-sigconf.tex\clearpage
\bibliographystyle{ACM-Reference-Format}
', 'api/v1/dataflow/real_static_files/operator/fab1e123-e28f-4f52-a03c-41075147723a.png', '2025-07-28 22:30:47.636405', '2025-07-30 14:42:09.515676');
INSERT INTO "public"."operator_info" VALUES (24, 'words_num_filter', 'Filter', 0, 'f', 'Filter to keep samples with total words number within a specific
    range.', '根据算子使用使用使用使用安装方案确定', NULL, 'api/v1/dataflow/real_static_files/operator/89e8db71-801e-4241-a637-1e28d55ee53b.png', '2025-07-29 16:56:11.789035', '2025-07-30 14:42:17.729019');
...
', 'api/v1/dataflow/real_static_files/operator/d7d1a896-6a66-404c-9230-1d589dce80cb.png', '2025-07-28 22:33:35.42515', '2025-07-30 14:42:27.543635');
INSERT INTO "public"."operator_info" VALUES (26, 'document_minhash_deduplicator', 'Deduplicator', 0, 'f', '
    ...
    ', NULL, NULL, 'api/v1/dataflow/real_static_files/operator/898a3cb8-fa01-4a7f-9a92-5de322bc4802.png', '2025-07-29 17:04:52.917296', '2025-07-30 14:40:00.661726');
INSERT INTO "public"."operator_info" VALUES (27, 'frequency_specified_field_selector', 'Selector', 0, 'f', 'Selector to select samples based on the sorted frequency of specified
    field.', '{''text'': ''，。、„”“«»１」「《》´∶：？！'',''count'': None,''meta'': {    ''suffix'': ''.html'',    ''key1'': {        ''key2'': {            ''count'': 18        },        ''count'': 48    }}}', NULL, 'api/v1/dataflow/real_static_files/operator/f04dcec3-5618-438a-a47a-3252b88f08cf.png', '2025-07-29 17:05:42.404482', '2025-07-30 14:42:38.548727');
INSERT INTO "public"."operator_info" VALUES (28, 'random_selector', 'Selector', 0, 'f', 'Selector to random select samples. ', '{''text'': ''，。、„”“«»１」「《》´∶：？！'',''count'': None,''meta'': {    ''suffix'': ''.html'',    ''key1'': {        ''key2'': {            ''count'': 18        },        ''count'': 48    }}}', NULL, 'api/v1/dataflow/real_static_files/operator/7375d836-71d1-4451-ad59-20e8a624e8d9.png', '2025-07-29 17:05:48.112859', '2025-07-30 14:42:45.36178');
INSERT INTO "public"."operator_info" VALUES (29, 'range_specified_field_selector', 'Selector', 0, 'f', 'Selector to select a range of samples based on the sorted
    specified field value from smallest to largest. ', '{''text'': ''，。、„”“«»１」「《》´∶：？！'',''count'': None,''meta'': {    ''suffix'': ''.html'',    ''key1'': {        ''key2'': {            ''count'': 18        },        ''count'': 48    }}}', NULL, 'api/v1/dataflow/real_static_files/operator/0e72f0dc-8ac4-40eb-9fa5-0219e7da0346.png', '2025-07-29 17:05:56.428539', '2025-07-30 14:42:53.870455');
INSERT INTO "public"."operator_info" VALUES (30, 'topk_specified_field_selector', '', 0, 'f', NULL, NULL, NULL, 'api/v1/dataflow/real_static_files/operator/2ef54c00-67b1-4b39-bc2b-682e6a7a7b59.png', '2025-07-29 17:06:02.746543', '2025-07-30 14:43:04.545865');
...
INSERT INTO "public"."operator_info" VALUES (33, 'remove_non_chinese_character_mapper', 'Mapper', 0, 'f', 'Mapper to remove non chinese Character in text samples.', '👊    所有的非汉字a44sh都12@46h会被*&……*qb^4525去掉', '所有的非汉字都会被去掉', 'api/v1/dataflow/real_static_files/operator/174b3132-9fe4-42a5-9191-b51b6ed92829.png', '2025-07-29 09:25:10.258087', '2025-07-30 14:43:29.975755');
...
INSERT INTO "public"."operator_info" VALUES (35, 'remove_specific_chars_mapper', 'Mapper', 0, 'f', 'Mapper to clean specific chars in text samples. now support: ◆●■►▼▲▴∆▻▷❖♡□', '多个●■►▼这样的特殊字符可以►▼▲▴∆吗？', '多个这样的特殊字符可以吗？', 'api/v1/dataflow/real_static_files/operator/69ea24c1-b010-4ab4-8735-ccf9338fb3ec.png', '2025-07-29 09:34:21.502534', '2025-07-30 14:43:50.369974');
...
The end of the table.', 'api/v1/dataflow/real_static_files/operator/52fcc0d8-9265-49e9-8d0f-5c488463e4f3.png', '2025-07-29 16:43:07.170951', '2025-07-30 14:44:11.203543');
...
INSERT INTO "public"."operator_info" VALUES (38, 'replace_content_mapper', 'Mapper', 0, 'f', 'Mapper to replace all content in the text that matches
    ...
    replacement string.', '多个●■►▼这样的特殊字符可以►▼▲▴∆吗？', '多个<SPEC>►▼这样的特殊字符可以►▼▲▴∆吗？', 'api/v1/dataflow/real_static_files/operator/9b1aa7d6-2265-47bc-9a6a-f0c83d3aa538.png', '2025-07-29 16:43:42.176801', '2025-07-30 14:44:28.552504');
...
The plant slaughters 19,500 pigs a day — 5 percent of U.S. pork.', 'api/v1/dataflow/real_static_files/operator/1e91ba97-1067-4f05-8654-375f6e00eadd.png', '2025-07-29 16:43:50.676209', '2025-07-30 14:44:36.669174');
INSERT INTO "public"."operator_info" VALUES (40, 'whitespace_normalization_mapper', 'Mapper', 0, 'f', '
    ...
    ', 'hello world', 'world hello', 'api/v1/dataflow/real_static_files/operator/b0aed94b-84b3-416a-b91b-444cca15ea02.png', '2025-07-29 16:43:56.227611', '2025-07-30 14:44:48.577719');
INSERT INTO "public"."operator_info" VALUES (41, 'average_line_length_filter', 'Filter', 0, 'f', 'Filter to keep samples with average line length within a specific
    range.', 'short', NULL, 'api/v1/dataflow/real_static_files/operator/21e83be6-d67e-4e1e-ba2c-4ae1c10b7d18.png', '2025-07-29 16:44:17.527904', '2025-07-30 14:44:58.221537');
...
You know', NULL, 'api/v1/dataflow/real_static_files/operator/fe9da7e9-ff19-4c92-b1cc-6456ab855441.png', '2025-07-29 16:45:37.653325', '2025-07-30 14:45:11.857961');
...
You know', NULL, 'api/v1/dataflow/real_static_files/operator/a8b4ff5e-2d12-40c5-b483-c6f4c8492ef5.png', '2025-07-29 16:46:18.557698', '2025-07-30 14:50:01.143674');
...
You know', NULL, 'api/v1/dataflow/real_static_files/operator/4b7e5905-74fe-42ba-97a5-b873e21421fa.png', '2025-07-29 16:46:34.277471', '2025-07-30 14:45:46.690086');
INSERT INTO "public"."operator_info" VALUES (45, 'special_characters_filter', 'Filter', 0, 'f', 'Filter to keep samples with special-char ratio within a specific
    range.', 'emoji表情测试下😊，😸31231', NULL, 'api/v1/dataflow/real_static_files/operator/ac509abf-55ba-47c7-8b5e-d5080dfbe3d9.png', '2025-07-29 16:46:45.170847', '2025-07-30 14:45:55.891903');
INSERT INTO "public"."operator_info" VALUES (46, 'specified_field_filter', 'Filter', 0, 'f', '
    ...
    ', '{''text'': ''中文也是一个字算一个长度'',''meta'': {    ''suffix'': ''.txt'',    ''star'': 100}}', NULL, 'api/v1/dataflow/real_static_files/operator/37412326-3231-4e0a-bc36-aa1e7f79dce4.png', '2025-07-29 16:46:52.653937', '2025-07-30 14:46:06.188056');
INSERT INTO "public"."operator_info" VALUES (47, 'specified_numeric_field_filter', 'Filter', 0, 'f', '
    ...
    ', '{''text'': ''中文也是一个字算一个长度'',''meta'': {    ''suffix'': ''.txt'',    ''star'': 100}}', NULL, 'api/v1/dataflow/real_static_files/operator/ecd85741-b01b-4447-b21a-d19df67aeec6.png', '2025-07-29 16:46:59.738091', '2025-07-30 14:46:15.195593');
INSERT INTO "public"."operator_info" VALUES (48, 'stopwords_filter', 'Filter', 0, 'f', 'Filter to keep samples with stopword ratio larger than a specific min
    value.', '?', NULL, 'api/v1/dataflow/real_static_files/operator/c584cde4-a0d4-4a47-9d69-1f80e1909add.png', '2025-07-29 16:47:06.907246', '2025-07-30 14:52:50.980428');
INSERT INTO "public"."operator_info" VALUES (49, 'suffix_filter', 'Filter', 0, 'f', 'Filter to keep samples with specified suffix.', '{''text'': ''中文也是一个字算一个长度'',Fields.suffix: ''.txt''}', NULL, 'api/v1/dataflow/real_static_files/operator/68fb57ba-1f98-436c-a929-daafce8d05d6.png', '2025-07-29 16:47:13.268523', '2025-07-30 14:46:36.201431');
INSERT INTO "public"."operator_info" VALUES (50, 'text_entity_dependency_filter', 'Filter', 0, 'f', '
    ...
    ', '上上下下左左右右', NULL, 'api/v1/dataflow/real_static_files/operator/336427a9-2ab8-430e-a45a-2a680a811925.png', '2025-07-29 16:50:09.302578', '2025-07-30 14:46:45.668245');
INSERT INTO "public"."operator_info" VALUES (51, 'token_num_filter', 'Filter', 0, 'f', 'Filter to keep samples with total token number within a specific
    range.', 'Today is Sund Sund Sund Sund Sund Sunda and it''s a happy day!', NULL, 'api/v1/dataflow/real_static_files/operator/438a3016-4ca3-4c21-8ed1-ffe0306b935a.png', '2025-07-29 16:55:55.213657', '2025-07-30 14:46:54.05137');

ALTER SEQUENCE "public"."operator_info" START WITH 1000;
-- ----------------------------
