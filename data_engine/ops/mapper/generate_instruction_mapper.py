...
class GenerateInstructionMapper(Mapper):
    ...
    def process(self, sample=None, rank=None):
        ...
        response_str = model.generate(input_prompt, self.sampling_params)
        message_list = []
    ...
    # @property
    # def description(cls):
    #     return """Mapper to generate new instruction text data.
    # """
    ...
    def init_params(cls):
        return [
            ...
            Param("similarity_threshold", DataType.FLOAT, None, 0.7),
        ]