...
from . import (audio_ffmpeg_wrapped_mapper, chinese_convert_mapper,
               ...
               generate_instruction_mapper, generate_code_qa_pair_mapper, image_blur_mapper,
...
from .generate_code_qa_pair_mapper import GenerateCodeQAPairMapper
