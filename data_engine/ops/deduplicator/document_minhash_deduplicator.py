...
from data_engine.utils.model_utils import prepare_sentencepiece_model
...
class DocumentMinhashDeduplicator(Deduplicator):
    ...
    def init_params(cls):
        return [
            Param("tokenization", DataType.STRING, {
                "space": "space",
                "punctuation": "punctuation",
                "character": "character",
                "sentencepiece": "sentencepiece",
            }, "space"),
            Param("window_size", DataType.PositiveFloat, None, 5),
            Param("lowercase", DataType.BOOLEAN, None, True),
            Param("ignore_pattern", DataType.STRING, None, None),
            Param("num_permutations", DataType.PositiveFloat, None, 256),
            Param("jaccard_threshold", DataType.ClosedUnitInterval, None, 0.7),
            Param("num_bands", DataType.PositiveFloat, None, None),
