...
from data_engine.ops import UNFORKABLE
from data_engine.utils import cache_utils
from data_engine.utils.compress import (CompressionOff,
                                        cleanup_compressed_cache_files,
                                        compress, decompress)
from data_engine.utils.fingerprint_utils import generate_fingerprint
from data_engine.utils.process_utils import setup_mp
            ...
            for op in operators:
                ...
                with TRACE_HELPER.trace_block(
                    ...
                    extraAttributes={
                        ...
                        "cpu": op.runtime_np() if not op.use_cuda() else 0,
                        "gpu": op.runtime_np() if op.use_cuda() else 0,
