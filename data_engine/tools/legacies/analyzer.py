...
from data_engine.tools.legacies.analysis import ColumnWiseAnalysis, OverallAnalysis
from data_engine.config import init_configs
from data_engine.format import load_formatter
from data_engine.ops import Filter, load_ops
...
class Analyzer:
    ...
    def run(self, load_data_np=None, skip_export=False):
        ...
        logger.info(f'The overall analysis results are \n: {self.overall_result}')
